...
const appCss = "/assets/styles-Bs-D_Y8r.css";
...
const $$splitComponentImporter = () => import("./index-C_EiJhKj.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premium UI/UX, radical Framer interactions, and production-grade Webflow deployment for global standard brands."
    }, {
      property: "og:title",
      content: "Alava Web Designers — Engineering Digital Scale"
    }, {
